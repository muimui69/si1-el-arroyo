...
export const ListBooks = () => {
    ...
    const { books, loadingBooks } = useProvider();
                        ...
                        <div className="py-8">
                            <div className="flex flex-row justify-between w-full mb-1 sm:mb-0">
                                ...
                                <div className="text-end">
                                    <button className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-custom-green  rounded-lg shadow-md " type="submit">
                                        Crear libro
                                    </button>
                                </div>
                            </div>
                            <div className="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8 ">
                                <div className="inline-block min-w-full overflow-hidden rounded-lg shadow ">
                                    <table className="min-w-full leading-normal">
                                        ...
                                        {
                                            books.map(({ id, titulo, fecha_publicacion, precio, categoria, editoriale, autores }, index) => (
                                                <tbody key={id}>
                                                    <tr>
                                                        ...
                                                        <td className={`px-5 py-5 text-sm ${index % 2 === 0 ? "bg-custom-grey" : "bg-white"} border-b border-gray-200`}>
                                                            {
                                                                autores.map(({ id, nombre }) => (
                                                                    <p key={id} className="text-gray-900 whitespace-no-wrap">
                                                                        {nombre}
                                                                    </p>
                                                                ))
                                                            }
