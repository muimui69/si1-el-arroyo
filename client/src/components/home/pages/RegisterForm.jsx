                            ...
                            <div className="g-6 flex h-full flex-wrap bg-custom-celeste items-center justify-center text-neutral-800 px-5 shadow-lg rounded-lg border-0">
                                <div className="p-10 ">
                                    <div className="text-center">
                                        <h2 className="mb-4 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Registrarse</h2>
                                    </div>
                                    {
                                        error && <p className="mb-8 px-2 py-6 rounded-md flex h-10 items-center justify-center bg-custom-warning text-sm font-medium text-custom-blue">La contraseña debe tener almenos 8 caracteres</p>
                                    }
